...
function Navbar() {
  ...
  return(
    <header className="sm:flex sm:justify-between sm:items-center lg:px-10 bg-green-600">
      <div className="flex items-center justify-between px-6 py-5">
        ...
        <div className="sm:hidden p-2" onClick={ () => setMobileMenu(!mobileMenu) }>
          <button type="button" className="block text-white hover:text-green-800 focus:text-green-800 focus:outline-none">
      ...
      <div className={ mobileMenu ? 'hidden sm:block' : 'flex justify-end'}>
        <div className="px-4 w-3/4 text-center sm:w-auto sm:text-right bg-orange-400 sm:flex">
          <Link activeClass="active"
                ...
                offset={0}
                duration={700}
                className="block text-white font-semibold py-4 px-2 hover:bg-green-800">I. About</Link>
          <Link activeClass="active"
                to="skills"
                spy={true}
                smooth={true}
                offset={0}
                duration={700}
                className="block text-white font-semibold py-4 px-2 mt-1 hover:bg-green-800 sm:mt-0 sm:ml-2">II. Experience</Link>
          <Link activeClass="active"
                to="featuredProjects"
                spy={true}
                smooth={true}
                offset={0}
                duration={700}
                className="block text-white font-semibold py-4 px-2 mt-1 hover:bg-green-800 sm:mt-0 sm:ml-2">III. Featured Work</Link>
          <Link activeClass="active"
                to="projects"
                spy={true}
                smooth={true}
                offset={0}
                duration={700}
                className="block text-white font-semibold py-4 px-2 mt-1 hover:bg-green-800 sm:mt-0 sm:ml-2">IV. Projects</Link>
          <Link activeClass="active"
                to="contact"
                spy={true}
                smooth={true}
                offset={0}
                duration={700}
                className="block text-white font-semibold py-4 px-2 mt-1 hover:bg-green-800 sm:mt-0 sm:ml-2">V. Contact</Link>
